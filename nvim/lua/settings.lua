...
vim.opt.guicursor = "n-v-c-i:ver25" -- ibeams
...
vim.o.softtabstop=4                 -- Makes it easier to know which line is current
...
vim.o.syntax="true"                 -- Makes it easier to know which line is currentt
vim.o.clipboard="unnamedplus"       -- Use system clipboard for everything
--vim.o.t_SI="something else"
